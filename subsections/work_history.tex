...
%            \item Led a computational search for emergent patterns in integer partition theory. 
%            \item Refined software to enable a stereo-vision camera to organicall identify the distances of objects. 
%            \item presented methods and results
%            \item 
        \end{itemize}

...
%            \item Built a \textbf{CI/CD} pipeline using \textbf{Jenkins} and \textbf{Docker} to compile, test, package, and distribute on commit. Facilitated the retirement of a 20-year tangle of VMs, cron jobs, and hotfixes.

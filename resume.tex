...
\begin{center}
    ...
    \includesvg[height=8px]{icons/envelope-regular.svg}
    \hbmp
    \href{mailto:ch@rles.uno}{ch@rles.uno}
    \hbump
    \includesvg[height=8px]{icons/link-solid.svg}
    \hbmp
    \href{www.charles.uno}{charles.uno}
    \hbump
    \includesvg[height=8px]{icons/phone-solid.svg}
    \hbmp
    \href{tel:+16512699245}{(651) 269-9245}
%    \hbump
%    \includesvg[height=8px]{icons/github-brands.svg}
%    \hbmp
%    \href{https://github.com/charles-uno}{charles-uno}
    \hbump
    \includesvg[height=8px]{icons/map-marker-alt-solid.svg}
    \hbmp
    Minneapolis, MN
